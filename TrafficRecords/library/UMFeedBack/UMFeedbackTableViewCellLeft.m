...
//        [self.contentView addSubview:line];
        ...
        messageBackgroundView.image = [[UIImage imageNamed:@"messages_left_bubble.png"] stretchableImageWithLeftCapWidth:21 topCapHeight:11];
...
- (void)layoutSubviews {
    ...
    messageBackgroundView.frame = CGRectMake(10, textLabelFrame.origin.y - 9, labelSize.width + 16, labelSize.height + 18);;
}
